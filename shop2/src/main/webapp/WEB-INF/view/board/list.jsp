	...
	<table class="w3-table w3-border">
		<tr>
			...
			<td><input type="submit" value="검색" class="w3-btn w3-blue">
				<input type="button" value="전체게시물 보기" class="w3-btn w3-blue"
				...
				<c:forEach var="board" items="${boardlist}">
					...
					<tr>
						...
						<td class="w3-left"><c:if test="${! empty board.fileurl}">
								...
								begin="1" end="${board.grplevel}">&nbsp;&nbsp;&nbsp;</c:forEach>
						...
						<td><fmt:formatDate value="${board.regdate}"
								...
								test="${today == rdate}">
								<fmt:formatDate value="${regdate}" pattern="HH:mm:ss" />
							</c:if> <c:if test="${todat != rdate }">
